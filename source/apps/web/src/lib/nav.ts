...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Alunos', href: '/app/alunos', icon: GraduationCap, requiresFeature: 'classes.manage' },
      { label: 'Cronograma', href: '/app/cronograma', icon: CalendarClock, requiresFeature: 'classes.manage' },
      { label: 'Planejamento', href: '/app/sala/planejamento', icon: ListChecks, requiresFeature: 'classes.manage' },
      { label: 'Plano de curso', href: '/app/sala/plano-curso', icon: ListOrdered, requiresFeature: 'classes.manage' },
      { label: 'Plano de aulas', href: '/app/sala/plano-diario', icon: CalendarClock, requiresFeature: 'classes.manage' },
      { label: 'Diário de classe', href: '/app/sala/diario', icon: NotebookPen, requiresFeature: 'classes.manage' },
      ...
      { label: 'Diário Infantil', href: '/app/diario-infantil', icon: BookMarked, requiresFeature: 'classes.manage' },
