...
export const metadata = { title: 'Conta · Edu On Way' };
      ...
      {gamiOn ? (
        <form action={updateGamificationAction} className={cardClass}>
          ...
          <p className="mb-3 text-xs text-muted-foreground">
            O aluno acumula pontos quando você premia e, opcionalmente, ao tirar boas notas. Ao
            atingir as faixas abaixo, ele desbloqueia as medalhas 🥉 🥈 🥇.
          </p>
