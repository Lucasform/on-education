    ...
    rows: [
      {
        ...
        unlocks: 'Tudo. Sem isso o app não sobe.',
        essencial: true,
      },
      {
        envs: ['DEV_SESSION_SECRET'],
        label: 'Segredo de sessão',
        unlocks: 'Login e sessões.',
        essencial: true,
      },
      {
        envs: ['ANTHROPIC_API_KEY'],
        label: 'WayOn (IA padrão — Claude)',
        unlocks: 'Geração de conteúdo, planos, ementa, correção.',
        essencial: true,
      },
    ],
  },
    ...
    rows: [
      {
        ...
        unlocks: 'Geração de imagem e chave própria OpenAI do professor.',
      },
      {
        envs: ['YOUTUBE_API_KEY'],
        label: 'Vídeo sugerido (YouTube)',
        unlocks: 'Anexa "📺 Vídeo sugerido" nos planos de aula.',
        hint: 'Google Cloud › API YouTube Data v3 › chave de API. Cota gratuita diária.',
      },
      {
        envs: ['APP_ENCRYPTION_KEY'],
        label: 'BYOK — chave durável',
        unlocks: 'Mantém a chave de IA do professor salva entre deploys.',
    ...
    rows: [
      {
        envs: ['RESEND_API_KEY'],
        label: 'E-mail (Resend)',
        unlocks: 'Comunicados por e-mail e relatório do aluno por e-mail.',
      },
      {
        envs: ['EVOLUTION_API_URL', 'EVOLUTION_API_KEY'],
        label: 'WhatsApp (Evolution API)',
        unlocks: 'Inbox e envio de mensagens por WhatsApp.',
      },
    ],
  },
];
